...
MSG_UI = {
    ...
    "progress_wait_results": "Attente de la disponibilité des résultats de calcul...",
    ...
    "units_label_length": "Longueurs (éléments)",
...
MSG_LOG = {
    ...
    "calc_ef_reload": "Calcul terminé : rechargement du modèle pour afficher les résultats...",
