...
"""
lang/lang_fr.py
Textes d'interface, journal et erreurs en français (langue de référence).
"""
...
MSG_UI = {
    ...
    "status_analysis_model": "Modèle analytique",
    "status_mesh": "Maillage : {state}",
    "status_fem_done": "Calcul effectué",
    "status_fem_cases": "Cas calculés : {count}",
    "status_family_concrete": "Béton",
    "status_family_steel": "Métal",
    "status_family_timber": "Bois",
    "status_family_composite": "Mixte",
    "status_stages_present": "Phases de construction",
    "status_stages_all_calculated": "Toutes les phases calculées",
    "status_overall_NotCreated": "Modèle analytique inexistant",
    "status_overall_Created": "Modèle analytique créé (non maillé)",
    "status_overall_Meshed": "Maillé (calcul EF non effectué)",
    "status_overall_Calculated": "Calculé",
    "status_overall_OutOfDate": "Résultats obsolètes",
    "status_mesh_mesh_no": "aucun",
    "status_mesh_mesh_available": "complet",
    "status_mesh_mesh_incomplete": "incomplet",
    "clear": "Effacer",
    ...
    "flight_mode_overlay": "Mode Navigation (Échap pour quitter)",
    "flight_control_forward_back": "Avancer / reculer",
    "flight_control_left_right": "Gauche / droite",
    "flight_control_up_down": "Monter / descendre",
    "flight_control_look": "Regarder : souris + clic droit",
    "flight_control_fast": "Accélération : Maj",
    "flight_control_slow": "Ralenti : Ctrl",
    "flight_control_reset": "Réinitialiser la vue : Home",
    "flight_control_exit": "Quitter : Échap",
    ...
    "progress_read_systems": "Lecture des systèmes structuraux...",
    ...
    "scene_light_elevation": "Élévation",
    "scene_light_reset": "Valeurs par défaut",
